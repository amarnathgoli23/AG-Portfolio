...
const Navigation = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all bg-black duration-300 ${
      isScrolled 
        ? 'bg-background/95 backdrop-blur-sm border-b border-primary/20 shadow-card' 
        : 'bg-transparent'
    }`}>
